...
@objc open class EmailControllerAPI : NSObject {
    ...
    open class func getEmailCount() -> Promise<CountDto> {
        ...
        getEmailCountWithRequestBuilder().execute { result in
            switch result {
            case let .success(response):
                deferred.resolver.fulfill(response.body)
            case let .failure(error):
     ...
     */
    open class func getEmailCountWithRequestBuilder() -> RequestBuilder<CountDto> {
    ...
    open class func getEmailHTML( emailId: UUID,  decode: Bool? = nil) -> Promise<String> {
        let deferred = Promise<String>.pending()
        getEmailHTMLWithRequestBuilder(emailId: emailId, decode: decode).execute { result in
            switch result {
            case let .success(response):
                deferred.resolver.fulfill(response.body)
            case let .failure(error):
    ...
    open class func getEmailHTMLJson( emailId: UUID,  decode: Bool? = nil) -> Promise<EmailHtmlDto> {
        ...
        getEmailHTMLJsonWithRequestBuilder(emailId: emailId, decode: decode).execute { result in
            switch result {
            case let .success(response):
                deferred.resolver.fulfill(response.body)
            case let .failure(error):
     ...
     */
    open class func getEmailHTMLJsonWithRequestBuilder(emailId: UUID, decode: Bool? = nil) -> RequestBuilder<EmailHtmlDto> {
    ...
    open class func getUnreadEmailCount() -> Promise<UnreadCount> {
        ...
        getUnreadEmailCountWithRequestBuilder().execute { result in
            switch result {
            case let .success(response):
                deferred.resolver.fulfill(response.body)
            case let .failure(error):
